...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if ([super init]) {
        ...
        _textField.inputView = dummyView;
        ...
        [_textField addTarget:self action:@selector(textFieldShouldReturn:) forControlEvents:UIControlEventEditingDidEndOnExit];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    [_channel invokeMethod:@"onSubmitted"
                 arguments:@{@"text": textField.text}];
    return NO;
}
